...
peal.get.summary <- function(Y = NULL, X = NULL, Z = NULL, id.site = NULL, weights = NULL) {
...
peal.fit.RI <- function(Y = NULL, X = NULL, Z = NULL, id.site = NULL, weights = NULL,
  ...
  if (common.s2) {
    ...
    fn <- function(parameter) {
      return(-lmm.profile3(par = parameter, pooled = F, reml, Y, X, Z, id.site, weights, ShXYZ)$lp)
    }
