...
fit.peal_Corr = peal.fit.RS(Y = NULL, X = NULL, Z = NULL,
                      id.site = NULL, weights = NULL,
                      pooled = F, reml = T,
                      common.s2 = T,
                      ShXYZ = ShXYZ,  # only need summary stats
...
sqrt(fit.peal_Corr$sigma_site2)* sqrt(fit.peal_Corr$s2)
sqrt(fit.peal_Corr$sigma_int2)* sqrt(fit.peal_Corr$s2)
sqrt(fit.peal_Corr$sigma_slope2) * sqrt(fit.peal_Corr$s2)

# sqrt(fit.peal_Corr$V)
