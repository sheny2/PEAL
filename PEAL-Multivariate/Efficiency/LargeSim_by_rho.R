...
##    (MODIFIED: now takes Sigma_e as an argument)
## ------------------------------------------------
...
## ------------------------------------------------
## 4. Fit helpers and packers (same as before)
## ------------------------------------------------
...
## ------------------------------------------------
## 5. One replicate wrapper (MODIFIED: takes Sigma_e)
## ------------------------------------------------
...
run_sim_for_rhos <- function(rho12, rho13, rho23,
  ...
  ## ------------------------------------------------
  ## Plots (same structure as your current code)
  ## ------------------------------------------------
...
## ------------------------------------------------
## 8. Run across all correlation settings
## ------------------------------------------------
...
all_out <- lapply(names(rho_grid), function(nm) {
  r <- rho_grid[[nm]]
  run_sim_for_rhos(rho12 = r[1], rho13 = r[2], rho23 = r[3],
                   N = 100, label = nm)
})
names(all_out) <- names(rho_grid)
