...
results <- readRDS("results50.rds")
results <- readRDS("results_cluster2.rds")
# results <- readRDS("results_cluster.rds")
N = 100
```
...
for (k in seq_along(results)[-15]) {
  # for (k in seq_along(results)[-69]) {
# for (k in   seq_along(results)[-73]) {
