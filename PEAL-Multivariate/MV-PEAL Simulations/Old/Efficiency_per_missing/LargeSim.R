...
simulate_one <- function(seed, Sigma_e, p1_base, p2_base, p3_base) {
  ...
  ## --- MAR missingness (now USING p1_base, p2_base, p3_base) ---
...
## ------------------------------------------------
## 5. One replicate wrapper (takes Sigma_e & missingness bases)
## ------------------------------------------------
...
## ------------------------------------------------
## 6. Helper to init matrices and long-format helper
## ------------------------------------------------
...
## ------------------------------------------------
## 7. BIG DRIVER: run whole pipeline for one missingness setting
## ------------------------------------------------
...
## ------------------------------------------------
## 8. Missingness grid and SLURM array dispatch
## ------------------------------------------------
...
miss_grid <- data.frame(
  ...
  #p1_base  = rep(0.20, 8),
  #p1_base  = rep(0.20, 8),
  #p1_base  = seq(0.1, 0.15, length.out = 8),
  #p2_base  = seq(0.1, 0.55, length.out = 8),
...
# Optional: save a summary object per array
