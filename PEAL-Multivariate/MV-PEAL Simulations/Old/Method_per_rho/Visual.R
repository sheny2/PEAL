...
# Bias (optionally abs(bias))
p_beta_bias <- ggplot(beta_summary_all_df,
                      aes(x = rho_frob, y = abs(bias),
  ...
  labs(
    ...
    y = "Absolute bias",
    title = "Bias of beta estimates across methods and correlation settings"
  )
...
p_beta_var <- ggplot(beta_RE,
  ...
  labs(
    ...
    title = "Relative efficiency of beta estimates across methods and correlation settings"
  )

# Coverage for betas
p_beta_cov <- ggplot(beta_summary_all_df,
                     aes(x = rho_frob, y = coverage,
                         color = Model, group = Model)) +
  ...
  labs(
    ...
    title = "Coverage of nominal 95% CIs for beta by method and correlation setting"
  )
...
p_sigmaRE_bias <- ggplot(sigmaRE_summary_all_df,
  ...
  labs(
    ...
    title = "Bias of random-effect SD estimates across correlation settings"
  )

# Relative efficiency for random-effect SDs
...
p_sigmaRE_var <- ggplot(sigmaRE_RE,
  ...
  labs(
    x = "Frobenius norm of off-diagonal correlations",
    y = "log Relative efficiency vs FULL_UN (variance ratio)",
    title = "Relative efficiency of random-effect SD estimates across correlation settings"
  )
...
p_sigmae_bias <- ggplot(sigmae_summary_all_df,
  ...
  labs(
    ...
    title = "Bias of residual SD estimates across correlation settings"
  )
...
p_sigmae_var <- ggplot(sigmae_RE,
  ...
  labs(
    x = "Frobenius norm of off-diagonal correlations",
    y = "log Relative efficiency vs FULL_UN (variance ratio)",
    title = "Relative efficiency of residual SD estimates across correlation settings"
  )
...
p_corr_bias <- ggplot(corr_offdiag,
  ...
  labs(
    ...
    title = "Bias of off-diagonal correlation estimates across correlation settings"
  )
...
p_corr_var <- ggplot(corr_RE,
  ...
  labs(
    x = "Frobenius norm of off-diagonal correlations",
    y = "log Relative efficiency vs FULL_UN (variance ratio)",
    title = "Relative efficiency of off-diagonal correlation estimates across correlation settings"
  )
