...
#' 
#' @param use_rcpp Logical. If TRUE, uses the optimized C++ backend with analytic gradients.
#'                 If FALSE, uses the pure R implementation. Note: C++ implementation
#'                 does not currently support observation weights.
