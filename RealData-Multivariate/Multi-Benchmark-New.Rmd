...
# Parameters
H <- 5  # Number of sites
m_hosp <- sample(30:40, H, replace = TRUE)  # Number of patients per site
...
par(mfrow = c(1, py))  
for (i in 1:py) {
  plot(res$B[,i], true_beta[,i], main = paste("Beta", i))
  points(res$B[,i][1], true_beta[,i][1], col = "red")
  abline(a = 0, b = 1, col = "blue", lwd = 1)
}

par(mfrow = c(1, 1))  
plot(sqrt(diag(res$D)), true_sigma)
points(sqrt(diag(res$D))[1], true_sigma[1], col = "red")
abline(a = 0, b = 1, col = "blue", lwd = 2)
```
