...
# Parameters
H <- 5  # Number of sites
m_hosp <- sample(40:50, H, replace = TRUE)  # Number of patients per site
...
```{r, eval = F}
source("DLMM_Engine-Multi-New.R")
# Run federated EM algorithm
results <- federated_mv_lmm(ShXYZ_multi)
print(results)
```
